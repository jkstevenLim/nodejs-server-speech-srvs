...
const STT_CREDENTIALS = JSON.parse(process.env.STTCRED);
const TTS_CREDENTIALS = JSON.parse(process.env.TTSCRED);
//console.log(process.env.TTSCRED);
//console.log(process.env.STTCRED);
